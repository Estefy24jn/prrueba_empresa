                                  ...
                                  <thead>
                                    <tr>
                                        ...
                                        foreach ($lstprecio as $lp) { 
                                          if(@$lp->idpre == 0){ $tienda = 1; }
                                        ?>
                                          <th class="text-center col-md-1"><?php print @$lp->precio; ?></th>  
                                        <?php
                                        }
                                        ?>  
                                    </tr>                            
                                    ...
                                    <?php 
                                      foreach ($pro as $pro) {
                                        ...
                                        <tr>
                                          ...
                                          foreach ($lstprecio as $lpc) { 
                                            foreach ($precpro as $pp) {
                                             if(@$lpc != NULL AND $pp != NULL){
                                              if(@$lpc->idpre == @$pp->id_precios AND @$pp->pro_id == @$pro->pro_id){
                                              ?>
                                                <td class="text-center col-md-1">
                                                  <input type="text" class="text-center actualizar" name="<?php print @$pp->id_precios; ?>" id="<?php print @$pp->pro_id; ?>" value="<?php print @$pp->monto; ?>"></td>
                                              <?php
                                              }
                                             } 
                                            }

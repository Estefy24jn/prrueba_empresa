 ...
 -->
    ...
    <!-- DATOS DE LOS PRODUCTOS A COMPRAR -->
      <div class="col-md-12" style="padding-bottom: 1px;">
        ...
        <div class="col-md-6" id="seccionproductos" style="padding-bottom: 0px; padding-right: 0px; ">

          <div class="col-md-12" style="padding-left: 0px; padding-right: 0px; padding-bottom: 0px;">
            <div class="box box-danger">
              <div class="box-header with-border">
                <h3 class="box-title">Producto Utilizados </h3>
                <div class="pull-right"> 
                    ...
                    <div class="box">
                      ...
                      <div class="form-group col-md-5 pull-right" style="padding-right: 0px; padding-left: 0px; margin-left: 0px;">
                        ...
                        <div id="" class="col-sm-6" style="padding-right: 0px;">
                         <input type="text" class="form-control text-right" name="valortotalproducto" id="valortotalproducto" value="<?php if(@$totalprod != NULL){ print number_format(@$totalprod,2); } else {print '0.00';}?>" readonly>
                        </div>
                      </div>
        ...
        <div class="col-md-6" id="seccionabonos" style="padding-bottom: 0px;">

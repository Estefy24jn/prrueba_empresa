...
/* ==== GUARDAR DATOS DE CABECERA ======================================*/
    ...
    $(document).on('change','#factura', function(){
      ...
      //Mensaje que esta repetida la compra
      $.ajax({
        type: "POST",
        dataType: "json",
        url: "<?php echo base_url('compra/check_repetida');?>",
        data: { factura: factura, },
        success: function(json) {
          //alert(json);
          if(json == 1){
            alert("Ya existe una compra ingresada con este número"); 
            //return false;
          }
...
/* =========================================================================*/
    ...
    $(document).on('click', '#nuev_pro', function() {
        <?php $this->session->set_userdata("nuevo_desde_compra", 's');
          $this->session->set_userdata("nuevo_desde_factura", 'n'); ?>
          //NUEVO METODO
          /* $(".button").fancybox({
          width : 650,
          height: 400,
    ...
    function aplica_descuento(){
        ...
        $.ajax({
            ...
            success: function(json) {
              ...
              valsubsubtotal = (stciva+stsiva).toFixed(2);
              ...
              if(valsubsubtotal == 'NaN') { valsubsubtotal = 0; }
            ...
            //  if(montototal == 0) { montototal = '0,00'; }
              ...
              if(montototal == 'NaN') { montototal = 0; }
                ...
                $('#msubtotaltotal').html('$ '+valsubsubtotal);
...
<div class="content-wrapper">
  ...
  <section class="content">
    <!--Para ingresar nuevo Proveedor-->
    <button id="nuev_proveedor" onclick="location.href = base_url + 'proveedor';" type="button" class="btn btn-info" title="Ingresar nuevo Proveedor">
      <i class="fa fa-cubes"></i> Nuevo Proveedor
    </button>
    <div class="row">
    <!-- DATOS DEL PROVEEDOR -->        
      <div class="col-md-12">
        ...
        <div class="box box-danger">
          <div class="box-header with-border">
            ...
            <div class="col-md-2" style="padding-left: 0px;">
              <button id="nuev_pro" type="button" class="btn btn-info" title="Ingresar nuevo producto">
                    ...
                    if(@$detcomp != NULL){
                      if (count($detcomp) > 0) {
                        foreach ($detcomp as $dc):
                          ...
                          $subtotaltotal = $subtotaltotal + ($stciva + $stsiva);
                    ...
                    <table class="table table-clear">
                      <tbody>
                        <tr>
                          ...
                          <td id="msubtotaltotal" class="text-right">$<?php print number_format(@$subtotaltotal,2); ?></td>                                        
                        <tr>
                        <tr>

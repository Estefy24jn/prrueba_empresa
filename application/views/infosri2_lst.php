...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1><i class="fa fa-list-alt"></i> Reporte SRI</h1>
    <ol class="breadcrumb">
 ...
 -->
              <div class="pull-right" style="padding-left: 10px;"> 
                <a id="btn_excel_sri01" class="btn bg-green-active color-palette btn-grad " href="http://localhost/sistema1/reporte/reportesri01" data-original-title="" title="Exportar Reporte a Excel"><i class="fa fa-file-excel-o"></i> Exportar Ventas</a>
                <a id="btn_excel_sri01" class="btn bg-green-active color-palette btn-grad " href="http://localhost/sistema1/reporte/reportesri02" data-original-title="" title="Exportar Reporte a Excel"><i class="fa fa-file-excel-o"></i> Exportar Nota de Credito</a>
              </div>                  

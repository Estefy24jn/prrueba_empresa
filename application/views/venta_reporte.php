...
<head>
  ...
  <link rel="shortcut icon" type="image/ico" href="<?php print $base_url; ?>public/img/log_IFT_ico.png" />
      ...
      <div class="col-xs-12 table-responsive">
        <table class="table table-striped">
          ...
          <tr>
            ...
            <th class="text-center col-md-1">Base Imponible 12</th>
            <th class="text-center col-md-1">Base Imponible 0</th>
            <th class="text-center col-md-1">IVA 12</th>
            <th class="text-center col-md-1">Subtotal</th>
            <th class="text-center col-md-1">Monto Total</th>
            <th class="text-center col-md-1">Ret IVA</th>
            <th class="text-center col-md-1">Ret Renta</th>
          </tr>
          </thead>
          <tbody>
          <?php
          ...
          ?>
            <tr <?php if($ven->estatus == 3){ ?> style="background-color: #DD4B39;" <?php } ?> >
              ...
              <td>$ <?php print number_format(@$ven->subconiva,2,",","."); ?></td>
              <td>$ <?php print number_format(@$ven->subsiniva,2,",","."); ?></td>
              <td>$ <?php print number_format(@$ven->montoiva,2,",","."); ?></td>
              <td>$ <?php print number_format(@$ven->subtotal,2,",","."); ?></td>
              <td>$ <?php print number_format(@$ven->montototal,2,",","."); ?></td>
              <td>$ <?php print number_format(@$ven->retiva,2,",","."); ?></td>
              <td>$ <?php print number_format(@$ven->retrenta,2,",","."); ?></td>
            </tr>
          <?php 
              }
            }
          ...
          <tr>
            ...
            <th> <?php print number_format("",2,",","."); ?></th>
            <th>$ <?php print number_format($bimponible12,2,",","."); ?></th>
            <th>$ <?php print number_format($bimponible0,2,",","."); ?></th>
            <th>$ <?php print number_format($iva12,2,",","."); ?></th>
            <th>$ <?php print number_format($subtotal,2,",","."); ?></th>
            <th>$ <?php print number_format($montototal,2,",","."); ?></th>
            <th>$ <?php print number_format($retiva,2,",","."); ?></th>
            <th>$ <?php print number_format($retrenta,2,",","."); ?></th>
          </tr>

  ...
  $(document).ready(function () {
   ...
   tablecomp=$('#dataTableRet').dataTable({
    ...
    $(document).on('click', '.upd_retencion', function(){
      var txt_id_comp = $("#txt_id_comp").val();
      ...
      if (confirm("Desea guardar la retencion de la compra?")){
        $.ajax({
             ...
             data: {txt_id_comp: txt_id_comp, txt_autorizacion: txt_autorizacion, fecha_ret: fecha_ret,
    ...
    $(document).on('click', '.btnguardardetalle', function(){ 
      ...
      /* Poner el porcentaje de retención automáticamente */
      $(document).on('click', '.editretiva', function(){
        //alert("hola");
         //var tmpval = $(this).val();
        var tmpvall = $( this ).attr('name'); 
         var montoiva = "<?php if(@$comp != NULL){ print $comp->montoiva; } else {print 0;}?>";
        /*var tmpval1 = (parseFloat($( this ).attr('name')) / 100 * montoiva).toFixed(2);
        $(this).val(parseFloat(tmpval1).toFixed(2)); */

        /* alert(tmpvall);
        alert(montoiva);
        alert(tmpvall/100*montoiva); */
        $(this).val(tmpvall/100*montoiva);
      });
          ...
          <div class="box-header with-border">
            <h3 class="box-title"><i class="fa fa-truck"></i> Datos de la Compra </h3> 
              <div class="pull-right"> 
                ...
                <input type="hidden" id="txt_id_comp" name="txt_id_comp" value="<?php if(@$comp != NULL){ print @$comp->id_comp;} else {print 0;} ?>">
              </div>
          </div>
          <div class="box-body">
            <div class="row">

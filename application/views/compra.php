...
<script type='text/javascript' language='javascript'>
  $(document).ready(function() {
    ...
    /*Carga de Datos en Datatable del sri */
    $('#dataTableObj').dataTable({
      ...
      'ajax': "compra/listadofacturasaimportar",
      'columns': [{
          "data": "ruc"
        },
        {
    ...
    $(document).on('click', '.view_ctas', function() {
      ...
      $('#loadingmessage').show();
      $.ajax({
        url: "<?php echo base_url('compra/cargar_sritxt'); ?>",
    ...
    <div class="row">
      ...
      <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
          ...
          <li><a href="#tabcarga" data-toggle="tab"><i class="fa fa-cart-plus" aria-hidden="true"></i> Cargar Compras SRI</a></li>
        </ul>
        ...
        <div class="tab-content">
                    ...
                    <div class="col-md-8" style="padding: 0px;">
                      ...
                      <div class="form-group col-md-4" style="margin-bottom: 0px; margin-top: 8px;padding: 0px;">
                        ...
                        <div class="input-group date col-sm-7">
                          ...
                          <input type="text" class="form-control pull-right validate[required]" id="desde" name="desde" value="<?php $fec =  str_replace('-', '/', $desde);
                      ...
                      <div class="form-group col-md-4" style="margin-bottom: 0px; margin-top: 8px; padding: 0px;">
                        ...
                        <div class="input-group date col-sm-9">
                          <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                          <input type="text" class="form-control pull-right validate[required]" id="hasta" name="hasta" value="<?php $fec =  str_replace('-', '/', $hasta);
                                                                                                                                @$fec = date("d/m/Y", strtotime(@$fec));
                                                                                                                                print $fec; ?>">
                    ...
                    <div class="col-md-4">
                      <div class="col-md-6" style="margin-bottom: 0px; margin-top: 8px; padding-left: 0px;">
                        <h4 style="margin-bottom: 0px; margin-top: 0px;">
                          <div id="monto"> Monto: <?php print number_format(@$totalg, 2, ",", "."); ?></div>
                        </h4>
                      </div>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="col-md-8" style="padding: 0px;">
                      ...
                      <div class="form-group col-md-4" style="margin-bottom: 0px; margin-top: 8px;padding: 0px;">
                        ...
                        <div class="input-group date col-sm-7">
                          <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                          <input type="text" class="form-control pull-right validate[required]" id="desdepro" name="desdepro" value="<?php $fec =  str_replace('-', '/', $desde);
                                                                                                                                      @$fec = date("d/m/Y", strtotime(@$fec));
                                                                                                                                      print $fec; ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group col-md-4" style="margin-bottom: 0px; margin-top: 8px; padding: 0px;">
                        ...
                        <div class="input-group date col-sm-9">
                          <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                          <input type="text" class="form-control pull-right validate[required]" id="hastapro" name="hastapro" value="<?php $fec =  str_replace('-', '/', $hasta);
                                                                                                                                      @$fec = date("d/m/Y", strtotime(@$fec));
                                                                                                                                      print $fec; ?>">
                    ...
                    <div class="pull-right" style="padding-top: 10px;">
                      <a class="btn btn-success btn-sm color-palette btn-grad" target="_blank" href="<?php print $base_url; ?>compra/reportecompra_detallefacturaXLS" data-original-title="" title="Exportar Detalle de Facturas">
                        <i class="fa fa-file-excel-o fa-1x"></i> Facturas
                      </a>
                      <a class="btn btn-success btn-sm color-palette btn-grad" target="_blank" style="margin-left: 5px;" href="<?php print $base_url; ?>compra/reportecompra_resumenproductoXLS" data-original-title="" title="Exportar Resumen por Productos">
                        <i class="fa fa-file-excel-o fa-1x"></i> Productos
                      </a>
                      <a class="btn btn-success btn-sm color-palette btn-grad" target="_blank" style="margin-left: 5px;" href="<?php print $base_url; ?>compra/reportecompra_resumenproveedorXLS" data-original-title="" title="Exportar Resumen por Proveedores">
          ...
          <div class="tab-pane" id="tabcarga">
            <div class="col-md-12" style="padding: 0px; margin: 0px;">
              <div class="box">
                <div class="box-header">
                  <div class="form-group col-md-12">
                    <div class="col-md-3" style="padding: 0px;">
                      <label for="txt_apellido">Archivo txt de SRI</label>
                    </div>
                    <div class="col-md-6">
                      <input type="file" id="xlsfile" name="xlsfile" size="255" value="<?php if (@$empresa != NULL) {
                                                                                          print @$empresa->tokenfirma;
                                                                                        } ?>" />
                    </div>
                    <div class="pull-right" style="padding: 0px;">
                      ...
                      <a class="btn btn-success btn-sm btn-grad load_ctas" target="_blank" href="<?php print $base_url;?>public/upload/tempsri.xlsx" data-original-title="" title="Descargar SRI"><i class="fa fa-save"></i> Descargar </a>
                    </div>
                  </div>
                ...
                <div class="overlay" id='loadingmessage' style='display:none'>
                  <img style="display: block; margin-left: auto; margin-right: auto; width: 50%;" src="<?php echo base_url() ?>public/img/ajax-loader.gif"/>
                </div>
                <!-- /.box-body -->
              </div>
            </div>

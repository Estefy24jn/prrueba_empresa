...
<div id = "contenido_alm" class="col-md-6">
    <div class="box box-danger">
        <div class="box-header with-border">
          <h3 class="box-title"></i> Detalle del Cheque</h3>
        </div>
                    ...
                    <table id="" class="table table-bordered table-hover table-responsive">
                        <thead>
                          ...
                          <tr>
                            ...
                            <th class="text-left col-md-1">Nuero Cuenta</th> 
                            <td class="text-center col-md-1"><?php print @$forpagodetalle->numerocuenta; ?></td>                             
                          </tr>  
                          <tr>

...
?>
 ...
 <footer class="main-footer">
      <!-- <a id="app-whatsapp" style="position: fixed; bottom: 95px; display: block; right: 24px; width: 60px; z-index: 1000;" target="_blank" href="https://api.whatsapp.com/send?phone=593992979013&amp;text=Hola!&nbsp;me&nbsp;pueden&nbsp;apoyar con soporte?">
        <i class="fa fa-whatsapp" style="font-size: 63px; color: #1ebea5;"></i>
      </a> -->
      <!-- <a id="app-messenger" style="position: fixed; display: block; right: 24px; bottom: 25px; width: 60px; z-index: 1000;" target="_blank" href="https://m.me/factuleon">
        <i class="fa fa-facebook" style="font-size: 63px; color: #0084ff;"></i>
      </a> -->
    <div class="pull-right hidden-xs">
      <b>Version</b> 3.0
    </div>
    
    <strong>Copyright &copy; 2019 <a href=<?php print $base_url ?>><?php print @$nombresistema; ?></a>.</strong> All rights
    reserved.
  </footer>
</div>
<!-- ./wrapper -->
...
<!-- <script>
  ...
  chatbox.setAttribute("page_id", "102140845312300");

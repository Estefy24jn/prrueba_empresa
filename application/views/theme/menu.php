<?php
  ...
  //$usu_caja = $usu_mod->usuario_model->lst_caja_efectivo($id);
  ...
  $imgmenu = $parametro->Sistema_model->sel_imgmenu();
...
<script>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      <!-- Sidebar user panel -->
      <!--Poner una imagen-->
      <div class="user-panel" style="padding-top: 15%; padding-bottom: 15%; padding-left: 0%; padding-right: 0%;">
        <!-- <img style="text-align: center; display: block; margin-left: auto; margin-right: auto; width: 100%;"
          src="<?php print base_url() . "/public/img/sucursal/" . @$imgmenu; ?>" 
          alt="" onerror="this.src='<?php print base_url() . "public/img/factuleon_logo.png"; ?>';" /> -->
        <!-- Img de empresa -->
          <!-- <img style="text-align: center; display: block; margin-left: auto; margin-right: auto; width: 70%;"
          src="<?php print base_url(); ?>public/img/factuleon_logo.png" 
          alt="" onerror="this.src='<?php print base_url() . "public/img/factuleon_logo.png"; ?>';" /> -->
        <!-- <div style="text-align: center; display: block; margin-left: auto; margin-right: auto;">
          <p style="color:#FFFFFF; text-align: center; display: block; margin-left: auto; margin-right: auto; line-height: 20px;">Factura como el León</p>
        </div> -->
        <div class="pull-left" style="padding: 0%;">
          <img style="padding:0%; margin-left: -4%; margin-top: -5%;" class="d-inline-block align-top" width="40%" height="50%" <?php
            if (@$fic_fot != NULL) {
        ...
        <div class="pull-left info" style="margin-left: 3%;">
          <p><?php  print $this->session->userdata("sess_na"); ?></p>
          <p> Business <i class="fa fa-circle text-success"></i></p>
        </div>
      </div>
...
<!--                   <a href="<?php print $base_url ?>facturar/factura_deposito"><i class="fa fa-newspaper-o"></i> Facturar</a>
 -->                </li>
               <!--  <?php }   ?>
            ...
            <?php if($perfil == 1  || $perfil == 3) { ?>
              <li><a href="<?php print $base_url ?>infosri"><i class="fa fa-send"></i> Comprobantes SRI</a></li> 
            <?php  }   ?>

            <?php if(($habilitaserie == 1) && ($perfil == 1)) { ?>
...
<!--                   <a href="<?php print $base_url ?>facturar/factura_deposito"><i class="fa fa-newspaper-o"></i> Facturar</a>
 -->                </li>
            ...
            <!--Antes Caja efectivo cambio de posicion-->
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <?php if(($perfil == 1) || ($perfil == 2) || ($perfil == 3)) { ?>
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-cubes" aria-hidden="true"></i> <span>Tesorería</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php print $base_url ?>infosri2"><i class="fa fa-send"></i> Reporte SRI</a></li>
        ...
        <?php if($perfil == 1 || $perfil == 3) { ?>            
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              ...
              <li><a href="<?php print $base_url ?>contab_balancesituacion"><i class="fa fa-balance-scale" aria-hidden="true"></i> Estados Financieros</a></li>
              ...
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                  ...
                  <li><a href="<?php print $base_url ?>contab_balancesituacion"><i class="fa fa-balance-scale"></i> Balance de General</a></li>
                </ul>
              </li>              
        ...
        <!-- <p style="color:#FFFFFF; text-align: center; line-height: 20px;">Extra</p>   -->

  <!--       <?php if($perfil == 1 || ($perfil == 4)) { ?>
        <li class="treeview">
          <a href="#">
            <i class="fa fa-cubes" aria-hidden="true"></i> <span>Cursos</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <?php if($perfil == 1 || ($perfil == 4)) { ?>            
            <li><a target="_blank" href="https://factuleon.com/curso/sistema-empresarial/lecciones/bienvenida/"><i class="fa fa-cubes"></i> Sistema</a></li>
            <?php } ?>
            <?php if(($perfil == 1) || ($perfil == 4)) { ?>
            <li><a href="<?php print $base_url ?>producto"><i class="fa fa-shopping-bag"></i> Pag. Web</a></li>
            <?php } ?>            
          </ul>
        </li>
        <?php } ?> -->
        ...
        <?php if($perfil == 1 || ($perfil == 3)) { ?>
        <li><a href="https://factuleon.com/curso/factura-como-un-leon/lecciones/bienvenidacopiar/" target="_blank"><i class="fa fa-cubes"></i> <span>Curso</span></a>
        </li>     
        <?php } ?>

        <?php if($perfil == 1 || ($perfil == 3)) { ?>
        <li><a href="https://m.me/factuleon?ref=w15486343" target="_blank"><i class="fa fa-cubes"></i> <span>Soporte</span></a>
        </li>     
        <?php } ?>

...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <!--Para ingresar nueva Compra-->
      <button id="nuev_compra" onclick="location.href = base_url + 'compra/agregar';" type="button" class="btn btn-info" title="Ingresar nueva Compra">
        <i class="fa fa-cubes"></i> Nueva Compra
      </button>
      <div class="row">
        <div class="col-xs-12">

...
<script type='text/javascript' language='javascript'>
  ...
  $(document).on('click', '#btn_venta_send', function(){
      $('.venta_send').each(function(index, el) {
        ...
        //Esto se carga desde Infosri/listadoVentas()
        //alert(id);
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <p style="font-size:140%;">Firma Válida: <?php print @$firma;?></p>
    <ol class="breadcrumb">
        ...
        <div class="box box-danger">
          <div class="box-header with-border">
              ...
              <div class="pull-right" style="padding-left: 10px;"> 
                <a id="btn_venta_send" class="btn btn-sm bg-blue-active color-palette btn-grad " href="#" data-original-title="" title="Enviar al SRI comprobantes en lote"><i class="fa fa-send"></i> Enviar SRI Lote</a>

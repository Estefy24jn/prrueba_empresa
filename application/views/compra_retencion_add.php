            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <table class="table table-bordered">
                        <tbody>
                          <tr>
                              <th style="width: 50%" class="text-right">Base Imponible Total</th>
                              <td><input style="width: 100px" type="text" class="form-control validate[required] text-center" id="txt_basetotal" name="txt_basetotal" value="<?php if(@$retencion != NULL){ print ($retencion->base_noiva+$retencion->base_iva); } else {print ($subtotalsiniva+$subtotalconiva);}?>" ></td>
                            </tr>
                            <tr>

    ...
    $(document).ready(function () {
        ...
        $('.actualiza').click(function(){
            ...
            $.ajax({
                ...
                $('#dataTableObjpyg').DataTable().ajax.reload();
                $('#dataTableObjcashflow').DataTable().ajax.reload();
                /* Se pasa un dato guardado en flash para cada consulta del reporte */
                //$('#cashflow').text("hola11");
                //<?php $tmp_pyg = $this->session->flashdata('pyg');  echo($tmp_pyg); ?>
                //$('#cashflow').text(<?php echo$tmp_pyg;?>);
      ...
      var tablepyg = $('#dataTableObjpyg').dataTable({
          "language":{  "lengthMenu":"Mostrar _MENU_ registros por página.",
                        "zeroRecords": "Lo sentimos. No se encontraron registros.",
                        "info": "Mostrando página _PAGE_ de _PAGES_",
                        "infoEmpty": "No hay registros aún.",
          ...
          'ajax': "contabilidad/contab_balance/listadoPerdidasyGanancias",
          'columns': [
              {"data": "grupo"},
              {"data": "cuenta"},
              {"data": "descripcion"},
      ...
      var tablecashflow = $('#dataTableObjcashflow').dataTable({
          "language":{  "lengthMenu":"Mostrar _MENU_ registros por página.",
                        "zeroRecords": "Lo sentimos. No se encontraron registros.",
                        "info": "Mostrando página _PAGE_ de _PAGES_",
                        "infoEmpty": "No hay registros aún.",
          ...
          'ajax': "contabilidad/contab_balance/listadoCashFlow",
          'columns': [
              {"data": "cuenta"},
              {"data": "valor"}
          ]
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <h3>Pérdidas y Ganancias </h3>
              <table id="dataTableObjpyg" class="table table-bordered table-striped table-responsive">
                <thead>
                  <tr >
                      <th>Grupo</th>
                      <th>Cuenta</th>
            ...
            <div class="box-body table-responsive">
              <h3 id="cashflow">Flujo de Caja: $ </h3>
              <table id="dataTableObjcashflow" class="table table-bordered table-striped table-responsive">
                <thead>
                  <tr >
                      <th>Cuenta</th>
                      <th>Valor</th>

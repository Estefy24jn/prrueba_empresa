  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Listado de Transportistas</li>
      </ol>
    </section>

    <!-- Main content -->
    <section class="content">
    <!--Para ingresar nueva Guia de remision-->
    <button id="nuev_guia" onclick="location.href = base_url + 'guiaremision/agregar';" type="button" class="btn btn-info" title="Ingresar nueva Guía de remisión">
                  <i class="fa fa-cubes"></i> Nueva Guía de Remisión
                </button>
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Listado de Transportistas</h3>

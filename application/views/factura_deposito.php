...
<head>
  ...
  <link rel="shortcut icon" type="image/ico" href="<?php print $base_url; ?>public/img/IconLeon.png" />
  ...
  <script type='text/javascript' language='javascript'>
    $(document).ready(function() {
      ...
      $('#txt_clinom').change(function() {
        var tab = $(this).val();
        $('#txt_clinom').val(tab.replace('\t', ''));
      });

      function abrirPopup(tcc) {
        $('#popup').fadeIn('slow');
        $('.popup-overlay').fadeIn('slow');
        $('.popup-overlay').height($(window).height());
        $('#tipocambiocliente').text("CAMBIO :" + tcc);
        return false;
      }
      ...
      var id_categoriaventa = <?php if (@$cliente != NULL) {
                                print $cliente->id_categoriaventa;
                              } else {
                                print 0;
                              }  ?>;
      var blinkProc = null;
      ...
      if (valfp == 'Contado') {
        ...
        $("#detforpagtmp").css("display", "block");
      } else {
        ...
        $.ajax({
          ...
          success: function(json) {
            if (json.mens == null) {
              ...
              $('#mendir').attr('class', 'col-md-9 has-error'); //nuevo
              $('#txt_clinom').val('');
              $('#txt_telf').val('');
              //$('#txt_correo').val('');
              $('#txt_dir').val('');
              ...
              $('#mendir').attr('class', 'col-md-9 has-success'); //nuevo
        ...
        $.ajax({
          ...
          success: function(json) {
            if (json.mens == null) {
              ...
              $('#mendir').attr('class', 'col-md-9 autocomplete has-success');
      ...
      //prueba de direccion
      $('#txt_dir').on('click', '.autocomplete-jquery-item', function() {
        //var dir = $('txt_dir').text();
        //var dir = $(this).text();
        var dir = $(this).val();
        //var dir1 = $('#txt_clid').text();
        $.ajax({
          type: "POST",
          dataType: "json",
          url: "<?php echo base_url('Facturar/busca_direccion'); ?>",
          data: {
            dir: dir
          },
          success: function(json) {

            //$('#txt_clid').text(json.mens.id_cliente);
            //$('#txt_nro_ident').val(json.mens.ident_cliente);
            //$('#txt_dir').val(json.mens.direccion_cliente);
            $('#txt_dir').text(json.mens.direccion_cliente);
      ...
      $(document).on('click', '.autocomplete-jquery-item', function() {
          //$('#txt_clinom').on('click', '.autocomplete-jquery-item', function() {
          //$('#txt_clinom').on('click', '.autocomplete-jquery-item', function() {

          var nom = $(this).text();
          //var nom = $('#txt_clinom').text();

          //dar click en correo luego a telefono
          if (nom === "") {
            alert("Debe ingresar un nombre");
            return false;
          }
          ...
          $.ajax({
            ...
            success: function(json) {
              ...
              $('#mennom').attr('class', 'col-md-10 has-success');
              $('#mendir').attr('class', 'col-md-9 has-success');
              $('#menid').attr('class', 'col-md-6 has-success');
              $('#txt_telf').val(json.mens.telefonos_cliente);
              $('#txt_correo').val(json.mens.correo_cliente);
              $('#txt_dir').val(json.mens.direccion_cliente);
              ...
              if (vendedorasociado != 0 && vendedorasociado != null) {
                $("#cmb_vendedor").val(vendedorasociado);
                perfil = <?php if (@$perfil != NULL) {
                            print $perfil;
                          } else {
                            print 0;
                          } ?>;
              ...
              //redirect('/facturar/factura_deposito');//Asegura los datos para la direccion  
              //location.reload
              registrar_cliente();
      ...
      function registrar_cliente() {
        ...
        $.ajax({
          ...
          success: function(json) {
            ...
            /*            var cliente = <?php if (@$cliente->nro_ident != NULL) {
                                          print $cliente->nro_ident;
                                        } else {
                                          print 0;
                                        } ?>;
                ...
                if (factsexis == 1) {
                  $.ajax({
                    ...
                    success: function(json) {
                      ...
                      $('#detalletmp').load(base_url + "Facturar/actualiza_tablageneral");
                      $('#detalletmp').load(base_url + "Facturar/actualiza_tablageneral");
                      alertTimeout("Producto Añadido con Éxito", 1000);
                      /*  credito();*/
                    }
                  });
                } else {
...
*/
      ...
      $(document).on('change', '.descpro', function() {
        ...
        var tipodescprod = <?php if (@$tipodescprod == 1) {
                              print 1;
                            } else {
                              print 0;
                            } ?>;
      ...
      */
      ...
      function actualizar_subtotales() {
        ...
        $.ajax({
          ...
          success: function(json) {
            ...
            var idforma = $("#cmb_tipfac option:selected").val();
            var habilitanotaventaiva = <?php if (@$habilitanotaventaiva != NULL) {
                                          print $habilitanotaventaiva;
                                        } else {
                                          print 0;
                                        }  ?>;
            ...
            if (forpago == "Contado") {
              ...
              if (tmppagado > 0) {
                abrirPopup(tmppagado.toFixed(2));
              }
            }
                  ...
                  if (json.resu == 1) {
                    ...
                    if (nro_ident.length > 4 && nom_cliente.length >= 3) {
                      ...
                      if ((parseFloat(montototal) > 0) && ((forpago != "Contado") ||
                        ...
                        contabiliza = <?php if (@$contabiliza != NULL) {
                                        print $contabiliza;
                                      } else {
                                        print 0;
                                      } ?>;
                        ...
                        if (contabiliza == 1) {
                          cuentasconfig = <?php if (@$cuentasconfig != NULL) {
                                            print ($cuentasconfig == true) ? 1 : 0;
                                          } else {
                                            print 0;
                                          } ?>;
                          //alert('cuentasconfig ' + cuentasconfig);
                          cuentasconfigcobro = <?php if (@$cuentasconfigcobro != NULL) {
                                                  print ($cuentasconfigcobro == true) ? 1 : 0;
                                                } else {
                                                  print 0;
                                                } ?>;
      ...
      function enviar_factura_sri(idfactura) {
        $.ajax({
          ...
          success: function(json) {
            $.blockUI({
              message: '<h3> Enviando comprobante al SRI ...</h3>'
            });
      ...
      function actualizar_botonpagar() {
        ...
        if ((parseFloat(montototal) > 0) && (parseFloat(efectivo) + parseFloat(tarjeta) >= parseFloat(montototal))) {} else {
          cambio = 0;
        }
      ...
      function credito() {
        ...
        if (interes == 'undefined' || interes == null || interes == '' || interes == "") {
          interes = 0;
        }
        var mora = $("#mora").val();
        if (mora == 'undefined' || mora == null || mora == '' || mora == "") {
          mora = 0;
        }
        var cuotas = $("#cuotas").val();
        if (cuotas == 'undefined' || cuotas == null || cuotas == '' || cuotas == "") {
          cuotas = 1;
        }
        abono = $("#totalcre").val();
        if (abono == 'undefined' || abono == null || abono == '' || abono == "") {
          abono = 0;
          $("#totalcre").val(abono);
        }
        if ((idforma == 2) || (habilitanotaventaiva == 1)) {
        ...
        if (diffecha > 0) {
          $.ajax({
            ...
            data: {
              ...
              abono: abono,
              forpago: forpago,
              montobasecredito: montobasecredito,
              montointerescredito: montointerescredito,
      ...
      function alertTimeout(mymsg, mymsecs) {
        document.getElementById("alertConfirmacionProducto").innerHTML = mymsg;
        var myelement = document.getElementById("alertConfirmacionProducto");
        myelement.setAttribute("style", "background-color: green;color:white; font-family:arial;font-size:15px;font-weight:bold; text-align: center;");
        setTimeout(function() {
      ...
      $(document).on('click', '#nuev_pro', function() {
        <?php
        $this->session->set_userdata("nuevo_desde_factura", 's');
        $this->session->set_userdata("nuevo_desde_compra", 'n'); ?>
        $.fancybox.open({
          type: "ajax",
          width: 550,
          height: 550,
          ...
          href: "<?php echo base_url('producto/agregar'); ?>"
        });
      });


      var muestraanticipo = <?php if (@$anticipo != NULL) {
                              print @$anticipo;
                            } else {
                              print 0;
                            } ?>;
...
<body class="hold-transition sidebar-mini">
  <header class="main-header" style="margin-left: 0px; background-color: #0445a2;">
    <nav class="navbar navbar-static-top" style="margin-left: 0px;">
      ...
      <div class="row" style="margin-left: 0px;">
        <div class="col-md-6" style="padding-top: 8px;">
          ...
          <button id="nuevo" type="button" class="btn btn-success boton-nuevo">
          ...
          <?php if (@$perfil == 1) { ?>
            <!-- <button id="<?php print $idusu; ?>" type="button" class="btn btn-info venta">
            <i class="fa fa-shopping-cart"></i> Ventas
          </button> -->
          <?php } ?>

          <!-- <button id="proformas" type="button" class="btn btn-info ">
          ...
          <button id="existencias" type="button" class="btn btn-info" title="Existencia en Almacenes">
            <i class="fa fa-cubes"></i> Existencia
          </button>

          <button id="compsri" type="button" class="btn btn-info" onclick="location.href='<?php print $base_url ?>infosri'" title="Comprobantes SRI">
        ...
        <div class="col-md-6">
          <p style="font-size: 20px; font-weight: bold; color: #FFFFFF; text-align: center; margin-top: 8px;">FACTURA ELECTRÓNICA</p>
          <!-- <span class="navbar-text">
            <p style="font-size: 18px; color: #FFFFFF; text-align: center; margin-top: 5px;">FACTURA ELECTRÓNICA</p>
          </span> -->
        </div>
      </div>
      ...
      <!-- <div class="col-md-3">
        <h3 style="margin-top: 13px; margin-bottom: 0px; color: #fff;"><?php //print $areamesa->nom_area." - ".$areamesa->nom_mesa; 
                                                                        ?></h3>
      </div> -->
      <!-- Poner foto de perfil para cerrar sesion -->
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img class="user-image" width="160px" height="160px" <?php
                                                                    if (@$fic_fot != NULL) {
                                                                      if ($fic_fot->fot_usu) {
                                                                        print " src='data:image/jpeg;base64,$fic_fot->fot_usu'";
                                                                      } else { ?> src="<?php print base_url(); ?>public/img/perfil.jpg" <?php }
                                                                                                                                    } else { ?> src="<?php print base_url(); ?>public/img/perfil.jpg" <?php } ?> alt="" onerror="this.src='<?php print base_url() . "public/img/perfil.jpg"; ?>';" />
            ...
            <ul class="dropdown-menu">
              <li class="user-header">
                ...
                <p>
                  ...
                  <small><?php //print $this->session->userdata("sess_tu"); 
                          ?></small>
                </p>
              </li>
  ...
  <section class="content" style="background-color: #ecf0f5;">
    <div class="row" style="padding-left: 2px; padding-right: 2px;">
      <div class="col-md-12">
        <div class="box box-primary" style="border-style: solid; border-color: #0445a2; border-width: 3px;">
          <div class="box-header with-border" style="background-color: #0445a2;">
            <?php
            //Un usuario con varias cajas puede elegir cual caja para facturar 
            if (count($lstcaja) > 1) { ?>
              <div class="col-md-2" style="margin-bottom: 5px; padding-left: 0px;">
              <?php
            } else { ?>
                <div class="col-md-2" style="margin-bottom: 5px; padding-left: 0px; display:none;">
                <?php
              }
                ?>
                <!-- <div class="col-md-2" style="margin-bottom: 5px; padding-left: 0px; display:none;"> -->
                <div class="form-group col-md-12" style="margin-bottom: 5px; padding-left: 0px; padding-right: 0px;">
                  <div class="col-md-3" style="font-weight: bold; color:#FFFFFF;">
                    <label>Caja</label>
                  </div>
                  <div class="col-md-9">
                ...
                <div class="col-md-3" style="margin-bottom: 5px; padding-left: 0px; padding-right: 0px;">
                  <div class="form-group col-md-12" style="margin-bottom: 5px; padding-left: 0px;">
                    <div class="col-md-5" style="font-weight: bold; color:#FFFFFF;">
                      <label>Documento</label>
                    </div>
                    <div class="col-md-7">
                      <input type="hidden" id="txt_idventa" name="txt_idventa" value="<?php if (@$cliente != NULL) {
                                                                                        print @$cliente->id_venta;
                                                                                      } ?>">
                    ...
                    <div class="col-md-9">
                      <div class="col-md-12 evapago" style="padding-right: 0px; padding-left: 0px;">
                        <?php if ($cliente->tipo_doc == 2) { ?>
                          <input type="text" class="form-control validate[required] text-center" id="factura" name="factura" disabled="" value="<?php if (@$nrofactura != NULL) {
                                                                                                                                                  print @$nrofactura;
                                                                                                                                                } ?>">
                        <?php } else { ?>
                          <input type="text" class="form-control validate[required] text-center" id="notaventa" name="notaventa" value="<?php if (@$nronv != NULL) {
                                                                                                                                          print @$nronv;
                                                                                                                                        } ?>">
                        <?php } ?>
                      </div>
                  ...
                  <div class="form-group col-md-12" style="margin-bottom: 5px; padding-left: 0px;">
                    ...
                    <div class="col-md-9">
                      <div class="input-group date">
                        <input type="text" class="form-control text-center validate[required]" id="fecha" name="fecha" value="<?php if (@$cliente != NULL) {
                                                                                                                                @$fec = str_replace('-', '/', @$cliente->fecha);
                ...
                <div class="col-md-3" style="margin-bottom: 5px; padding-left: 0px; padding-right: 0px; display:none;">
                  <div class="form-group col-md-12" style="margin-bottom: 5px; padding-left: 0px;">
                    <div class="col-md-4">
                ...
                <?php if (($vernumerorden == 1) && (@$cliente->nro_orden != NULL)) { ?>
                  <div class="col-md-1" style="margin-bottom: 5px; padding-left: 0px; padding-right: 0px;">
                    <div class="form-group col-md-12" style="margin-bottom: 5px; padding-left: 0px;">
                      ...
                      <input type="text" class="form-control validate[required] text-center" readonly id="" name="" value="<?php if (@$cliente != NULL) {
                                                                                                                              print @$cliente->nro_orden;
                                                                                                                            } ?>">
                    </div>
                  </div>
                <?php } ?>
              ...
              <div class="box-body">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <p class="box-title" style="font-weight: bold; color:#0445a2; text-align: center; font-size: 20px;">Paso 1: Datos de cliente</p>
                    <!--Datos de cliente-->
                      ...
                      <div class="col-md-2" style="margin-bottom: 5px; padding-left: 0px; padding-right: 0px;">
                        <div class="form-group col-md-12" style="margin-bottom: 5px; padding-left: 0px;">
                          ...
                          <div class="col-md-8" style="padding-right: 0px; padding-left: 0px;">
                            <input type="text" class="form-control validate[required]" name="txt_codigocliente" id="txt_codigocliente" placeholder="Código Cliente" value="<?php if (@$cliente != NULL) {
                    ...
                    <!-- Solo 3 columnas -->
                    <!--              <div class="row">
                  <div class="col-md-4" style="text-align: right;">.col-md-4</div>
                  <div class="col-md-4">.col-md-4</div>
                  <div class="col-md-4">.col-md-4</div>
                </div>
 -->
                    <div class="row">
                      <div class="col-md-3" style="margin-bottom: 5px; padding-left: 0px; padding-right: 0px; padding: 0 15px;">
                        <div class="form-group col-md-12" style="margin-bottom: 5px; padding-left: 0px; ">
                          <div class="col-md-4" style="padding-right: 0px; padding: 0 15px;">
                            <label>Tipo</label>
                          </div>
                          <div class="col-md-8 tipident" style="padding-right: 0px; padding-left: 0px;">
                            <select id="cmb_tipident" name="cmb_tipident" style="font-size: large; border-radius: 4px;" class="form-control">
                              <?php
                              if (@$tipident != NULL) { ?>
                              <?php } else { ?>
                                <option value="0" selected="TRUE">Seleccione...</option>
                                ...
                                foreach ($tipident as $ti) :
                                  if (@$cliente->tipo_ident != NULL) {
                                    ...
                                    <?php
                                      ...
                                      <!--Otras opciones de tipo de identidad-->
                      ...
                      <div class="col-md-4" style="margin-bottom: 5px; padding-left: 0px; padding-right: 0px; padding: 0 15px;">

                        <div class="form-group col-md-12" style="margin-bottom: 5px; padding-left: 0px;">
                          <div class="col-md-4">
                            <label>Nro.Identidad</label>
                          </div>
                          <div id="menid" class="col-md-8" style="padding-right: 0px; padding-left: 0px;">
                            <input type="hidden" id="txt_clid" name="txt_clid" value="<?php if (@$cliente != NULL) {
                                                                                        print @$cliente->id_cliente;
                                                                                      } ?>">
                            <input type="text" class="form-control validate[required]" style="font-size: large; border-radius: 4px;" name="txt_nro_ident" id="txt_nro_ident" placeholder="Nro ID" value="<?php if (@$cliente != NULL) {
                                                                                                                                                                                                            print @$cliente->nro_ident;
                                                                                                                                                                                                          } ?>">
                          </div>
                        </div>
                      ...
                      <div class="col-md-5" style="margin-bottom: 5px; padding-left: 0px; padding-right: 0px; padding: 0 15px;">
                        <div class="form-group col-md-12" style="margin-bottom: 5px; padding-left: 0px;">
                          <div class="col-md-2">
                            <label>Cliente</label>
                          </div>
                          <div id="mennom" class="col-md-10 autocomplete" style="padding-left: 0px; padding-right: 0px;">
                            <input type="text" class="form-control" style="font-size: large; border-radius: 4px;" name="txt_clinom" id="txt_clinom" placeholder="Nombre del Cliente" value="<?php if (@$cliente != NULL) {
                                                                                                                                                                                              print @$cliente->nom_cliente;
                                                                                                                                                                                            } ?>" data-source="<?php echo base_url('facturar/valclientenombre?nombre='); ?>">
                          </div>
                        </div>
                      </div>

                    </div><!-- Cerrar el primer div row -->
                    <div class="row">
                      <!-- Abrir segunda row -->
                      <div class="col-md-3" style="margin-bottom: 5px; padding-left: 0px; padding-right: 0px; padding: 0 15px;">
                        <div class="form-group col-md-12" style="margin-bottom: 5px; padding-left: 0px;">
                          ...
                          <div id="" class="col-md-8" style="padding-right: 0px; padding-left: 0px;">
                            <input type="text" class="form-control col-md-3 guarda_cliente" style="font-size: large; border-radius: 4px;" name="txt_correo" id="txt_correo" placeholder="Correo" value="<?php if (@$cliente != NULL) {
                                                                                                                                                                                                          print @$cliente->correo_cliente;
                                                                                                                                                                                                          if (empty(@$cliente->correo_cliente)) {
                                                                                                                                                                                                            print @$correo_default;
                                                                                                                                                                                                          } //correo empresa
                                                                                                                                                                                                        } ?>">
                          </div>
                        </div>
                      ...
                      <div class="col-md-4" style="margin-bottom: 5px; padding-left: 0px; padding-right: 0px; padding: 0 15px;">
                        <div class="form-group col-md-12" style="margin-bottom: 5px; padding-left: 0px;">
                          ...
                          <div id="" class="col-md-8" style="padding-right: 0px; padding-left: 0px;">
                            <input type="text" class="form-control col-md-3 guarda_cliente" style="font-size: large; border-radius: 4px;" name="txt_telf" id="txt_telf" placeholder="Teléfono" value="<?php if (@$cliente != NULL) {
                                                                                                                                                                                                        print @$cliente->telf_cliente;
                                                                                                                                                                                                      } ?>">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-5" style="margin-bottom: 5px; padding-left: 0px; padding-right: 0px; padding: 0 15px;">
                        <div class="form-group col-md-12" style="margin-bottom: 5px; padding-left: 0px; ">
                          ...
                          <!-- se aumenta autocomplete -->
                          <div id="mendir" class="col-md-9 autocomplete" style="padding-left: 0px; padding-right: 0px;">
                            <input type="text" class="form-control guarda_cliente" name="txt_dir" id="txt_dir" style="font-size: large; border-radius: 4px;" placeholder="Dirección" value="<?php if (@$cliente != NULL) {
                                                                                                                                                                                print @$cliente->dir_cliente;
                                                                                                                                                                              } ?>" data-source="<?php echo base_url('facturar/valclientedireccion?direccion='); ?>">
                          </div>
                        </div>
                      </div>

                    </div><!-- Cerrar el segundo div row -->
                  </div>
                  ...
                  <div class="form-group col-md-12" style="margin-bottom: 5px; padding-left: 0px;">
                    ...
                    <div id="" class="col-md-8" style="padding-right: 0px; padding-left: 0px;">
                      <input type="text" class="form-control col-md-3 guarda_cliente" name="txt_correo" id="txt_correo" placeholder="Correo" value="<?php if (@$cliente != NULL) {
                                                                                                                                                      print @$cliente->correo_cliente;
                                                                                                                                                    } ?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group col-md-12" style="margin-bottom: 5px; padding-left: 0px; ">
                    ...
                    <div id="" class="col-md-10" style="padding-right: 0px; padding-left: 0px;">
                      <input type="text" class="form-control col-md-3 guarda_cliente" name="txt_dir" id="txt_dir" placeholder="Direccion" value="<?php if (@$cliente != NULL) {
                                                                                                                                                    print @$cliente->dir_cliente;
                                                                                                                                                  } ?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group col-md-12" style="margin-bottom: 5px; padding-left: 0px;">
                    ...
                    <div id="" class="col-md-8" style="padding-right: 0px; padding-left: 0px;">
                      <input type="text" class="form-control col-md-3 guarda_cliente" name="txt_ciudad" id="txt_ciudad" placeholder="Ciudad" value="<?php if (@$cliente != NULL) {
                                                                                                                                                      print @$cliente->ciu_cliente;
                                                                                                                                                    } ?>">
                    </div>
                  </div>
                </div> -->
                  ...
                  <div class="form-group col-md-12" style="margin-bottom: 5px; padding-left: 0px;">
                    ...
                    <div id="" class="col-md-8" style="padding-right: 0px; padding-left: 0px;">
                      <input type="text" class="form-control col-md-3 guarda_cliente" name="txt_placa" id="txt_placa" placeholder="Placa" value="<?php if (@$cliente != NULL) {
                                                                                                                                                    print @$cliente->placa_matricula;
                                                                                                                                                  } ?>">
                    </div>
                  </div>
                </div> -->

                    <div class="col-md-4 itemcredito" style="display: none;">
                      <input type="hidden" id="txt_creditotope" name="txt_creditotope" value="<?php if (@$mcredito != NULL) {
                                                                                                print @$mcredito->topecredito;
                                                                                              } else {
                                                                                                print 0;
                                                                                              } ?>">
                      <div class="col-md-4" style="margin-bottom: 5px; padding-left: 0px; padding-right: 0px; display: none;">
                        <div class="form-group col-md-12" style="margin-bottom: 5px; padding-left: 0px;">
                          <div class="col-md-5">
                            <label>Crédito</label>
                          </div>
                          <div id="" class="col-md-7" style="padding-right: 0px; ">
                            <input type="text" class="form-control col-md-3 text-right" name="txt_creditod" id="txt_creditod" placeholder="" value="<?php if (@$mcredito != NULL) {
                                                                                                                                                      print @$mcredito->total;
                                                                                                                                                    } else {
                                                                                                                                                      print 0;
                                                                                                                                                    } ?>" disabled>
                          </div>
                      ...
                      <div class="col-md-4" style="margin-bottom: 5px; padding-left: 0px; padding-right: 0px; display: none;">
                        <div class="form-group col-md-12" style="margin-bottom: 5px; padding-left: 0px;">
                          ...
                          <div id="" class="col-md-6" style="padding-right: 0px; ">
                            <input type="text" class="form-control col-md-3 text-right" name="txt_creditop" id="txt_creditop" placeholder="" value="<?php if (@$mcredito != NULL) {
                                                                                                                                                      print @$mcredito->pendiente;
                                                                                                                                                    } else {
                                                                                                                                                      print 0;
                                                                                                                                                    } ?>" disabled>
                          </div>
                      ...
                      <div class="col-md-4" style="margin-bottom: 5px; padding-left: 0px; padding-right: 0px; display: none;">
                        <div class="form-group col-md-12" style="margin-bottom: 5px; padding-left: 0px;">
                          ...
                          <div id="" class="col-md-7" style="padding-right: 0px; ">
                            <input type="text" class="form-control col-md-3 text-right" name="txt_creditolimite" id="txt_creditolimite" placeholder="" value="<?php if (@$mcredito != NULL) {
                                                                                                                                                                print @$mcredito->topecredito;
                                                                                                                                                              } else {
                                                                                                                                                                print 0;
                                                                                                                                                              } ?>" disabled>
                    ...
                    <div class="col-md-12" style="margin-bottom: 5px; padding-left: 0px; padding-right: 0px;">
                      <?php if (@$cliente != NULL) {
                        if ($cliente->id_categoriaventa == 0) { ?>
                          ...
                          <div id="" class="col-md-10 " style="padding-right: 0px; padding-left: 0px;">
                            <input type="text" class="form-control col-md-3 guarda_cliente" style="font-size: large; border-radius: 4px;" name="txt_obs" id="txt_obs" placeholder="Observaciones" value="<?php if (@$cliente != NULL) {
                                                                                                                                                                                                            print @$cliente->observaciones;
                                                                                                                                                                                                          } ?>">
                          </div>
                            </div>
                            ...
                            <div class="col-md-1" id="divCategVenta" style="display:none">
                              <div class="blinking">
                                <img class="img-circle " class="user-image" width="25px" height="25px" id="imgCateg" <?php if ($cliente->icono_path != '') { ?> src="<?php print base_url(); ?>public/img/categoriaventa/<?php print $cliente->icono_path; ?>" <?php } else { ?> src="<?php print base_url(); ?>public/img/perfil.jpg" <?php }  ?> />
                                <label id="labelObs"><?php if (@$cliente != NULL) {
                                                        print $cliente->categoriaventa;
                                                      } ?></label>
                              </div>
                            </div>
          ...
          <!-- Primera Caja si esta bien -->
          <!-- Aqui va box Footer -->
        </div>
        <div style="padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px;">
          <!-- <div class="col-md-12" style="background-color: #45ba58; padding-left: 0px; padding-right: 0px;"> -->
          <!-- <div class="col-md-12" style="padding-right: 0px; padding-left: 0px;"> -->

          <div class="box box-primary" style="border-style: solid; border-color: #0445a2; border-width: 3px; padding-top: 0px; padding-bottom: 0px; padding-left: 0px; padding-right: 0px;">
            <div class="box-header with-border" style="background-color: #0445a2; padding-top: 5px; padding-bottom: 2px; padding-left: 0px; padding-right: 0px; margin-right: 1px; margin-top: 1px;">


              <div class="col-md-2" style="padding-left: 0px; text-align: center; padding-top: 4px;">
                <h3 class="box-title" style="font-weight: bold; color:#FFFFFF;">Paso 2: Productos a Facturar</h3>
              </div>
              <div class="col-md-2" style="text-align: center; padding-bottom: 2px;">
                <button id="nuev_pro" type="button" class="btn btn-default" title="Ingresar nuevo producto">
                  <i class="fa fa-cubes"></i> Nuevo Producto
                </button>
              </div>
              <div class="col-md-2 " style="text-align: center; padding-bottom: 2px;">
                <button type="button" style="font-size : 18px; background-color: #ff851b;" class="btn" data-toggle="modal" data-target="#myModal"><i class="fa fa-search"> Buscar Producto</i></button>
              </div>
              <!-- 
            <div class="col-md-2">
              <button id="nuev_pro" type="button" class="btn btn-default" title="Ingresar nuevo producto">
            ...
            <div class="form-group col-md-2">
              <button type="button" style="font-size : 18px;" class="btn btn-info btn-xs" data-toggle="modal" data-target="#myModal"><i class="fa fa-search"> Buscar Producto</i></button>
            </div> -->
              ...
              <div class="col-md-2">
                <input type="text" class="form-control col-md-3 codbar text-center" style="font-size: large; border-radius: 4px;" name="txt_codbar" id="txt_codbar" placeholder="Código de Barra" value="">
              </div>

              <div class="form-group col-md-2" style="padding-right: 0px; padding-left: 0px; margin-left: 0px; display: <?php if (count($almacenes) > 0) {
                                                                                                                          print 'block';
                                                                                                                        } else {
                                                                                                                          print 'none';
                                                                                                                        } ?>;">
                <label for="" class="col-sm-4 control-label text-right" style="padding-right: 0px; padding-left: 0px; font-weight: bold; color:#FFFFFF;">Almacen</label>
                <div class="col-sm-8 tipalmacenes" style="padding-right: 15px;">
                  <select id="cmb_almacenes" name="cmb_almacenes" class="form-control" style="font-size: large; border-radius: 4px; ">
                    <?php
                    if (@$almacenes != NULL) { ?>
                    <?php } else { ?>
                      <option value="0" selected="TRUE">Seleccione...</option>
              ...
              <table class="table table-bordered">
                <thead>
                  <tr>
                    ...
                    <?php if ($descpro == 1) { ?>
                      <th class="text-center col-md-1"><?php if (@$tipodescprod == 1) {
                                                          print '% ';
                                                        } ?>Desc</th>
                    <?php } ?>
                ...
                <tbody>
                  ...
                  foreach ($lstdetalle as $det) {
                    $num++;
                  ?>
                    <tr class="detallepro" id="<?php print $det->id_detalle; ?>" title="<?php if (@$det->id_serie != NULL) {
                                                                                          print 'Serie: ' . $det->numeroserie;
                                                                                        } ?>">
                      <td>
                        <?php print $num; ?>
                      ...
                      <td class="text-center datacantidad" id="<?php print @$det->id_detalle ?>">
                        <input type="text" class="form-control text-center cantidad tdprecio" name="" id="<?php print @$det->id_detalle ?>" value="<?php if (@$det != NULL) {
                                                                                                                                                      print number_format(@$det->cantidad, $decimalescantidad);
                                                                                                                                                    } ?>">
                      </td>
                      <div class="tipo_precio">
                        <?php if ($tp == 1) { ?>
                      ...
                      <td class="text-center">
                        <input type="text" class="form-control text-center precio tdprecio editnocoma" name="" id="<?php print @$det->id_detalle ?>" value="<?php if (@$det != NULL) {
                                                                                                                                                              print number_format(@$det->precio, $decimalesprecio);
                                                                                                                                                            } ?>" <?php if ((@$cambioprecio == 1) && (@$perfil != 1)) {
                                                                                                                                                                  print "disabled";
                                                                                                                                                                } ?>>
                      </td>
                      <td class="text-right">
                      ...
                      <?php if ($descpro == 1) { ?>
                        <td class="text-center">
                          <input type="text" class="form-control text-center descpro" name="" id="<?php print @$det->id_detalle ?>" value="<?php if (@$det != NULL) {
                                                                                                                                              if (@$tipodescprod == 1) {
                                                                                                                                                $tmpdesc = @$det->porcdesc;
                                                                                                                                              } else {
                                                                                                                                                $tmpdesc = @$det->descmonto;
                                                                                                                                              }
                                                                                                                                              print number_format(@$tmpdesc, 2);
                                                                                                                                            } ?>">
                        </td>
                      <?php } ?>
                      ...
                      <?php if ($habilitadetalletotaliva == 1) { ?>
                        <td class="text-center">
                          <div id="<?php print @$det->id_detalle; ?>" class="detalletotaliva">
                            <?php if ($det->pro_grabaiva == 1) {
                              $tmpvalor = round(($det->precio * $det->cantidad - $det->descmonto) * (1 + $tarifaiva), 2);
                            } else {
                              $tmpvalor = $det->descsubtotal;
                            }
                            print number_format($tmpvalor, 2); ?>
                          </div>
                        </td>
                      <?php } ?>
                      ...
                      <td class="text-center">
                        <?php if (($habilitaserie == 1) && ($det->estserie > 0)) { ?>
                          <a href="#" title="Nro Serie/Imei" id="<?php if (@$det != NULL) {
                                                                    print @$det->id_producto;
                                                                  } ?>" name="<?php if (@$det != NULL) {
                                                                              print @$det->id_detalle;
                                                                            } ?>" class="btn btn-xs btn-warning btn-grad pro_serimei"><i class="fa fa-slack"></i></a>
                        <?php } ?>
                        <a href="#" title="Eliminar" id="<?php if (@$det != NULL) {
                                                            print @$det->id_detalle;
                                                          } ?>" class="btn btn-xs btn-danger btn-grad pro_del"><i class="fa fa-trash-o"></i></a>
                      </td>
                    </tr>
                  <?php
            ...
            <div class="box-footer">
              ...
              <!--Antes de Cancelacion abajo-->

              <div class="col-md-6">
                <!-- <div id="calmonto" class="pull-right"> -->
                <div id="calmonto">
                  <table class="table table-clear calmonto">
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td id="msubtotalconiva" class="text-right msubtotalconiva">$<?php // print number_format(@$stciva,2,",","."); 
                                                                                        ?></td>
                        <tr>
                        <tr>
                          <td class="text-left"><strong>Subtotal IVA 0 %</strong></td>
                          <td id="msubtotalsiniva" class="text-right msubtotalsiniva">$<?php // print number_format(@$stsiva,2,",","."); 
                                                                                        ?></td>
                        <tr>
                          <?php if ($descpro == 0) { ?>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td id="" class="text-right">
                            <input type="text" class="text-right descuento" name="" id="descuento" value="<?php // print number_format(@$desc,2,",","."); 
                                                                                                          ?>" style="width:70px;">
                          </td>
                        </tr>
                      <?php } ?>
                      <tr>
                        ...
                        <td id="descsubiva" class="text-right descsubiva">$<?php // print number_format(@$dstciva,2,",","."); 
                                                                            ?></td>
                      </tr>
                      <tr>
                        <td class="text-left"><strong>Subtotal con Descuento IVA 0 %</strong></td>
                        <td id="descsubcero" class="text-right descsubcero">$<?php // print number_format(@$dstsiva,2,",","."); 
                                                                              ?></td>
                      </tr>
                      <tr>
                        <td class="text-left"><strong>IVA (12%)</strong></td>
                        <td id="miva" class="text-right miva">$<?php // print number_format(@$montoiva,2,",","."); 
                                                                ?></td>
                      </tr>
                      <?php if ($impuestoadicional > 0) { ?>
                        <tr>
                          <td class="text-left"><strong><?php print $descripcionimpuestoadicional; ?></strong></td>
                          <td id="impuestoadicional" class="text-right">$<? //php $totalimp = $subtotal * $impuestoadicional / 100; print number_format(@$totalimp,2,",","."); 
                                                                          ?></td>
                        </tr>
                      <?php } ?>
                      <tr>
                        <td class="text-left"><strong>Total</strong></td>
                        <td id="mtotal" class="text-right mtotal"><strong>$ <?php // $total = $subtotal + $montoiva; print number_format(@$total,2,",","."); 
                                                                            ?></strong></td>
                      </tr>
                    <?php
                      } else { ?>
                    ...
                    <tr>
                      <td class="text-left"><strong>Total</strong></td>
                      <td id="mtotaln" class="text-right mtotaln"><strong>$ <?php // $total = $subtotal + $montoiva; print number_format(@$total,2,",","."); 
                                                                            ?></strong></td>
                    </tr>
              ...
              <!-- Termina col 1 -->
              <!--Columna Cancelacion Abajo-->
              <div class="col-md-6" style="background-color: #ecf0f5; border-radius: 12px;">

                <!-- <div class="col-md-12" style="padding-left: 0px; padding-right: 0px; background-color: #B80C09;"> -->
                <div class="col-md-12" style="padding-left: 0px; padding-right: 0px;">
                  <!-- class="box box-primary" Estilo de caja -->
                  ...
                  <div class="box-header">
                    ...
                    <span class="">
                      <input type="hidden" class="totalefectivo" id="totalefectivo" value="<?php if ($efectivo != NULL) {
                                                                                              print $efectivo;
                                                                                            } else {
                                                                                              print 0;
                                                                                            } ?>">
                      <input type="hidden" class="totalcontado" id="totalcontado" value="<?php if ($abono != NULL) {
                                                                                            if ($idfp == "Contado") {
                                                                                              print $abono;
                                                                                            } else {
                                                                                              print 0;
                      ...
                      <label class="radio-inline">
                        <input type="radio" id="forpago" name="optionsRadios" <?php if ($idfp == "Contado") {
                                                                                print "checked";
                                                                              } ?> value="Contado"> Contado
                      </label>
                      <label class="radio-inline">
                        <input type="radio" id="forpago" name="optionsRadios" <?php if ($idfp == "Credito") {
                                                                                print "checked";
                  ...
                  <div id="detforpagtmp" class="box-body table-responsive" style="display: block;">
                    <table class="table table-bordered">
                      <thead>
                        <tr>
                          <th style="width: 10px">#</th>
                      ...
                      <tbody>
                        ...
                        ?>
                            <tr class="" id="">
                              ...
                              <td class="text-center montoformapago" id="<?php if (@$lfp != NULL) {
                                                                            print @$lfp->idreg;
                                                                          } ?>" name="<?php if (@$lfp != NULL) {
                                                                                      print @$lfp->monto;
                                                                                    } ?>">
                                <?php print $lfp->monto; ?>
                              </td>
                              <td class="text-center">
                                <a style="color: #094074;" href="#" title="Editar" id="<?php if (@$lfp != NULL) {
                                                                                          print @$lfp->idreg;
                                                                                        } ?>" name="<?php if (@$lfp != NULL) {
                                                                                                    print @$lfp->id_formapago;
                                                                                                  } ?>" class="fp_edi"><i class="fa fa-pencil-square-o fa-lg"></i></a> &nbsp;&nbsp;
                                <a style="color: #B80C09;" href="#" title="Eliminar" id="<?php if (@$lfp != NULL) {
                                                                                            print @$lfp->idreg;
                                                                                          } ?>" name="<?php if (@$lfp != NULL) {
                                                                                                      print @$lfp->id_formapago;
                                                                                                    } ?>" class="fp_del"><i class="fa fa-minus-circle fa-lg"></i></a>
                              </td>
                            </tr>
                        <?php
                          }
                  ...
                  <div id="detcforpagtmp" class="box-body table-responsive" style="padding: 0px;">
                    <div class="col-md-3" style="padding-left: 0px; margin-bottom: 0px;">
                      ...
                      <div style="padding-left: 0px; margin-bottom: 0px; width: 88px;" class="form-group">
                        <div class="input-group date">
                          ...
                          <input class="form-control pull-right validate[required]" id="fechal" name="fechal" value="<?php if (@$crecuo->fechalimite != NULL) {
                                                                                                                        @$fecl = str_replace('-', '/', @$crecuo->fechalimite);
                                                                                                                        @$fecl = date("d/m/Y", strtotime(@$fecl));
                                                                                                                        print @$fecl;
                                                                                                                      } else {
                                                                                                                        print date("d/m/Y");
                                                                                                                      } ?>" type="text">
                    ...
                    <div class="col-md-2" style="padding-left: 0px; margin-bottom: 0px;">
                      ...
                      <div style="padding-left: 0px; margin-bottom: 0px; width: 50px;" class="form-group">
                        <input class="form-control pull-right validate[required] text-center" id="dias" name="dias" value="<?php if ($crecuo != NULL) {
                                                                                                                              print $crecuo->dias;
                                                                                                                            } else {
                                                                                                                              print 0;
                                                                                                                            } ?>" type="text" readonly>
                    ...
                    <div class="col-md-3" style="padding-left: 0px; margin-bottom: 0px;">
                      ...
                      <div style="padding-left: 0px; margin-bottom: 0px; " class="form-group">
                        <input class="form-control pull-right validate[required] text-center" id="cuotas" name="cuotas" value="<?php if ($crecuo != NULL) {
                                                                                                                                  print $crecuo->cantidadcuotas;
                                                                                                                                } else {
                                                                                                                                  print 1;
                                                                                                                                } ?>" type="text">
                      </div>
                    ...
                    <div class="col-md-2" style="padding-left: 0px; padding-right: 0px; margin-bottom: 0px;">
                      ...
                      <div style="padding-left: 0px; margin-bottom: 0px; " class="form-group">
                        <input class="form-control pull-right validate[required] text-center" id="interes" name="interes" value="<?php if ($crecuo != NULL) {
                                                                                                                                    print $crecuo->p100interes_credito;
                                                                                                                                  } else {
                                                                                                                                    print 0;
                                                                                                                                  } ?>" type="text">
                      </div>
                    ...
                    <div class="col-md-2" style="padding-right: 0px; margin-bottom: 0px;">
                      ...
                      <div style="padding-left: 0px; margin-bottom: 0px; " class="form-group">
                        <input class="form-control pull-right validate[required] text-center" id="mora" name="mora" value="<?php if ($crecuo != NULL) {
                                                                                                                              print $crecuo->p100interes_mora;
                                                                                                                            } else {
                                                                                                                              print 0;
                                                                                                                            } ?>" type="text">
                      </div>
                    ...
                    <div class="col-md-12" style="padding-right: 0px; padding-bottom: 0px; padding-top: 10px; ">
                      ...
                      <div class="col-md-3 pull-right" style="padding-right: 0px; ">
                        <input class="form-control pull-right validate[required] text-center" id="totalcre" name="totalcre" value="<?php if ($abono != NULL) {
                                                                                                                                      print $abono;
                                                                                                                                    } else {
                                                                                                                                      print 0;
                                                                                                                                    } ?>" type="text" readonly>
                        ...
                        <tbody>
                          ...
                          ?>
                              <tr class="" id="">
                                ...
                                <td class="text-center">
                                  <a style="color: #094074;" href="#" title="Editar" id="<?php if (@$lfpc != NULL) {
                                                                                            print @$lfpc->idreg;
                                                                                          } ?>" name="<?php if (@$lfp != NULL) {
                                                                                                      print @$lfp->id_formapago;
                                                                                                    } ?>" class="fp_edi"><i class="fa fa-pencil-square-o fa-lg"></i></a> &nbsp;&nbsp;
                                  <a style="color: #B80C09;" href="#" title="Eliminar" id="<?php if (@$lfpc != NULL) {
                                                                                              print @$lfpc->idreg;
                                                                                            } ?>" name="<?php if (@$lfp != NULL) {
                                                                                                        print @$lfp->id_formapago;
                                                                                                      } ?>" class="fp_del"><i class="fa fa-minus-circle fa-lg"></i></a>
            ...
            <!-- Terminan Subtotales y forma de pago -->
            <div class="box-footer ">
                ...
                <div class="form-group col-md-6 text-left">
                  ...
                  <div id="anticipo">
                    ...
                    <div class="col-sm-4" style="padding-left: 0px;">
                      <input type="text" class="form-control" name="txt_anticipo" id="txt_anticipo" readonly="true" value="<?php if (@$anticipo != NULL) {
                                                                                                                              print number_format(@$anticipo, 2);
                                                                                                                            } else {
                                                                                                                              print '0';
                                                                                                                            } ?>" style="width:70px;">
                    </div>
                  ...
                  <div id="popup" style="display: none;">
                    <div class="content-popup">
                      <div class="close"><a href="#" id="close"><img src="<?php print base_url(); ?>public/img/close.png" /></a></div>
                      <div>
                        <strong>
                          <h2>CAMBIO </h2>
                        </strong>
                        ...
                        <strong><span style="font-size: 25px;" id="tipocambiocliente"></span></strong>
                      </div>
                    </div>
                  </div>
                </div>
  ...
  <footer class="main-footer " style="margin-left: 0px; height: 30px; margin-bottom: 8px;">
    <div class="pull-right hidden-xs">
      <b>Version</b> 3.0
    </div>
    <strong>Copyright &copy; 2019-2020 <a href="#"><?php print @$nombresistema; ?></a>.</strong> All rights
    reserved.
  </footer>
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
        ...
        <div class="table-responsive">
          <table id="TableProducto" class="table table-bordered table-hover ">
            ...
            <tbody>
              ...
              foreach ($pro as $p) {
              ?>
                <tr class="factaddpro idpropre" style="background-color: <?php if ($p->existencia <= $p->min and $p->existencia > 0 and $p->preparado == 0 && $p->pro_esservicio == 0) {
                                                                            print '#FFB40F'; //Alerta naranja pocas unidades menores que el minimo
                                                                          } else {
                                                                            if ($p->existencia <= 0 and $p->preparado == 0 && $p->pro_esservicio == 0) {
                                                                              print '#DD4B39'; //Alerta Roja no tiene unidades
                                                                            } else {
                                                                              print '#fff';
                                                                            }
      ...
      <div class="modal-footer">
        <div id="alertConfirmacionProducto">

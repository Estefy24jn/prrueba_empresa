...
/* === GUARDAR EL PRECIO EN LA TABLA TEMPORAL Y REALIZAR CALCULO === */
    ...
    /*Para guias de remision, agregar nuevo transportista */
    $(document).on('click', '#nuev_trans', function() {
      location.href= base_url + "transportista";
          /* $.fancybox.open({
            width: "90%",
            height: "90%",
            type: "iframe",
            href: "<?php echo base_url('transportista');?>"
          });
...
<div class="content-wrapper">
  ...
  <section class="content">
    <!--Para ingresar nuevo transportista-->
    <button id="nuev_trans" type="button" class="btn btn-info" title="Ingresar nuevo transportista">
                  <i class="fa fa-cubes"></i> Nuevo Transportista
                </button>
    <div class="row">
    <!-- DATOS DEL PROVEEDOR -->        
      <div class="col-md-12">

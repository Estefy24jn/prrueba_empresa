...
<!--        <script src="<?php print $base_url; ?>public/js/common.js"></script>-->
    ...
    <body background="<?php print @$imagenfondo;?>">
    <!-- <body background="<?php print base_url() . "public/img/login/restaurant1.jpg"; ?>"> -->
        ...
        <div height="80px" class="animated">
        ...
        <div class="content-w3ls animated pulse" style="margin-top: 10%;">
            ...
            <h3 class="animated bounceIn" style="color: #000; padding-bottom: 20px; font-weight: 700;   font-size: 22px;"> &nbsp; SISTEMA EMPRESARIAL FACTULEON </h3>
            <form name="popup-validation" id="popup-validation" onsubmit="return false">
                ...
                <!--    <div class="col-xs-8">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12" style="text-align: center; display: block; margin-left: auto; margin-right: auto; width: 50%;">
                    ...
                    <!-- <div class="col-md-12">
                        <span class=" pull-right"><strong> ON LINE</strong></span>
                    </div> -->
                </div>
            </form>
        </div>
            <p class="copyright">© <?php print @$nombresistema; ?> 2019-2021.
                <br> Factura como el León usando <a href="https://www.factuleon.com" target="_blank">Factuleon</a>  <br/>
            </p>

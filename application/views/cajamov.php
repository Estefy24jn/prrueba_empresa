            ...
            <div class="col-md-12">
                <div class="box box-danger">
                    <div class="box-header with-border">
                      ...
                      <div id="buscrango">
                        <div class="form-group col-md-2 " style="margin-bottom: 0px; margin-top: 0px; padding-right:0px; margin-right:30px;">
                        ...
                        <div class="form-group col-md-2 " style="margin-bottom: 0px; margin-top: 0px; padding-left:0px; padding-right:0px; margin-right:30px;">

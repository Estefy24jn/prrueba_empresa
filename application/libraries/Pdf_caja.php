...
#----------------------------------------------------------------------------------------------------------------------------------
    ...
    function Footer(){
		...
		*/
        ...
        /* $this->text(80, 287, utf8_decode('info@sinaiestetica.com - www.sinaiestetica.com'));
        $this->text(65, 284, utf8_decode('Telfs: 02 5106 765 - 0995 298 045 - 0984 963 635 * Quito - Ecuador'));   */      

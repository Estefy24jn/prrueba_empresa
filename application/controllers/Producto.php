...
*/
   ...
   /* ABRIR VENTANA PARA MODIFICAR */
    ...
    public function guardar(){
        ...
        //Se quita los checks todos los productos disponibles
        ...
        //Se quita los Checks todos los productos tienen que estar disponibles
        ...
        /* SE PASA LA VARIABLE DE SESION PARA ABRIR FACTURACION o PRODUCTOS AL TERMINAR DE GUARDAR */ 
        if($this->session->userdata('nuevo_desde_factura') == 's'){ 
            //$this->session->set_userdata("nuevo_desde_factura", NULL);
            $this->session->unset_userdata("nuevo_desde_factura");
            $this->session->unset_userdata("nuevo_desde_compra");
            
            print "<script> window.location.href = '" . base_url() . "facturar/factura_deposito'; </script>";
            //print_r($this->session->userdata());
        }elseif($this->session->userdata('nuevo_desde_compra') == 's'){
            
            //$this->session->set_userdata("nuevo_desde_compra", NULL);
            $this->session->unset_userdata("nuevo_desde_compra");
            $this->session->unset_userdata("nuevo_desde_factura");
            print "<script> window.location.href = '" . base_url() . "producto/agregar'; </script>";
            //print "<script> window.location.href = '" . base_url() . "compra/agregar'; </script>";
            //print_r($this->session->userdata());
        }
        else{

...
class Cliente extends CI_Controller {
    ...
    public function listadoDataCli() {
        ...
        //$id_empresa = $this->Correo_model->getemp_usuario($id);
        //$registro = $this->cliente_model->sel_cli($id_empresa->id_empresa);
    ...
    public function guardar(){
        ...
        /* INGRESAR CLIENTES A LA EMPRESA DONDE SE HACE LOGIN */
        $idusu = $this->session->userdata("sess_id");
        ...
        if($idcli != 0){
            ...
            $idcli = $this->cliente_model->cli_add($tip_ide, $nro_ide, $nivel, $nom, $correo, $telf, $ciu, $ref, $dir, $rel, 
                                                   $may, $pre, $ven, $codigo, $credito, $placa, $catcontable, $categventa, $id_empresa->id_empresa);
            $resu = $this->cliente_model->precio_cli($idcli, $arrpre);
        }
   ...
   /* Verificar Identificador CLIENTE  */
    public function existeIdentificacion(){
        ...
        /*Para hacer clientes multiempresa*/
        $idusu = $this->session->userdata("sess_id");        
        $id_empresa = $this->Correo_model->getemp_usuario($idusu);
        /*ORIGINAL
        $resu = $this->cliente_model->existeIdentificacion($id, $identificacion);
        */
        $resu = $this->cliente_model->existeIdentificacion($id, $identificacion, $id_empresa->id_empresa);
        $arr['resu'] = $resu;
        print json_encode($arr);

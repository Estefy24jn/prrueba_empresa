  ...
  function CreaDivParaPDF($objXml="", $pdf){
    ...
    $divstr='<html>';
      ...
      $divstr.='<tr>';
        ...
        /* $divstr.='<div class="cuadro_der" style="float:left;width:300px; border:1px solid #000; padding:5px; border-radius:5px ">';
          $divstr.='<div class="row" style="font-size:15px; margin: 50px;"> R.U.C: '.$xmlFact->infoTributaria->ruc.' </div>';
          $divstr.='<div class="row" style="font-size:16px"> FACTURA </div>';
          $divstr.='<div class="row" style="font-size:14px"> NÚMERO DE FACTURA </div>';
          ...
          $divstr.='<div class="row" style="font-size:14px;margin: 10px 0px;"> EMISIÓN: '.$tipoemision.'</div>';
      ...
      $divstr.='<div clas="datos_cliente" style="clear:left;border:1px solid #000; margin:12px 0px">';
        $divstr.='<table>';
          $divstr.='<tr>';
          $divstr.='<td style="font-size:14px;">Razón Social / Nombres y Apellidos: '.$xmlFact->infoFactura->razonSocialComprador.'</td>';
          $divstr.='</tr>';
          $divstr.='<tr>';
          $divstr.='<td style="font-size:14px;">Identificación: '.$xmlFact->infoFactura->identificacionComprador.'</td>';
          $divstr.='</tr>';
          $divstr.='<tr>';
          $divstr.='<td style="font-size:14px;">Fecha Emisión: '.$xmlFact->infoFactura->fechaEmision.'</td>';
          $divstr.='</tr>';
        $divstr.='</table>';
      $divstr.='</div>';          
...
/*          $subsidio = 0;
      ...
      $divstr.='<tr>';
        ...
        $divstr.='<div class="row" style="font-size:13px;margin:6px 0px"> Forma de Pago:'.$mostrarFormaPago.'</div>';
          ...
          if ($impresionsubsidio == 1){
            ...
            $impTotal = number_format((double)$xmlFact->infoFactura->importeTotal,2);
              ...
              $divstr.='<table style="margin-left:10px; border: 1px solid #000; border-collapse: collapse;padding-left:10px;">';
                ...
                $divstr.='<th width="102" style="font-size:10px;padding:0px 3px;border: 1px solid #000;text-align:right;">'.($impSubsidio + $impTotal) .'</th>';            
                $divstr.='</tr>';
                $divstr.='<tr>'; 
              ...
              $divstr.='<div class="cuadro_logo" style="height:100px; padding-top:40px; ">';

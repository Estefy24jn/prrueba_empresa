...
class Cliente_model extends CI_Model {
  ...
  public function cli_add($tip_ide, $nro_ide, $niv, $nom, $correo, $telf, $ciu, $ref, $dir, $rel, $may, $pre, $ven, $codigo, 
                          $credito, $placa, $catcontable, $categventa, $id_empresa){
    ...
    $query = $this->db->query("call cliente_ins('$nom', '$tip_ide', '$nro_ide', '$niv', 
                                                ...
                                                $catcontable, $categventa, $id_empresa);");
    $result = $query->result();
    $query->next_result(); 
    $query->free_result();     
  ...
  //public function sel_cli($id_empresa){
    /*Los administradores pueden ver todos los clientes */
    $usua = $this->session->userdata('usua');
    $perfil = $usua->perfil;
    $datos_empresa = $this->Correo_model->getemp_usuario($usua->id_usu);
    $consulta = "SELECT id_cliente, tipo_ident_cliente, 
                                ...
                                if($perfil != 1){
                                  $consulta = $consulta . " and id_empresa = $datos_empresa->id_empresa ";  
                                  /* if($id_empresa != "" || $id_empresa == 0){
                                    $consulta = $consulta . " and id_empresa = $id_empresa ";  
                                  }else{
                                    $consulta = $consulta . " and id_empresa = $datos_empresa->id_empresa ";  
                                  } */
                                  
                                }
                                $consulta = $consulta . " order by nom_cliente ";
  ...
  public function existeIdentificacion($idcliente, $identificacion, $id_empresa){

...
class Empresa_model extends CI_Model {
    ...
    public function emp_get() {
      ...
      */
        ...
        $perfil = $usua->perfil;
        $consulta = "SELECT * FROM empresa "; /* consumidor final */
        if ($perfil != 1) { //Obtiene todos los almacenes si es administrador
        $consulta = $consulta . " WHERE id_emp = $datos_empresa->id_empresa ";
        } 
    ...
    public function emp_ins($cod, $nom, $ruc, $rs, $ema, $tlf, $fax, $dir, $rep, $web, $img, $token, $obligadocontabilidad){
        if ($obligadocontabilidad == '') { $obligadocontabilidad = 0; }

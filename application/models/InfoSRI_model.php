...
class InfoSRI_model extends CI_Model {
    ...
    public function datosfactura($id_factura){
        $sel_obj = $this->db->query("SELECT c.nom_cliente, 
                                            ...
                                            c.direccion_cliente as dir_cliente, c.correo_cliente, c.telefonos_cliente, v.id_empresa,
                                            substr(v.nro_factura,9,9) as nro_factura, DATE_FORMAT(v.fecha, '%Y-%m-%d') as fecha, 

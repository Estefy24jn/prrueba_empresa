   ...
   methods: {
         show_parametros: function(){
            ...
            this.$http.get('hot_conf_show').then(function(respuesta){
               ...
               swal("No se pudo recuperar los Parametros", "Por Favor Intenta Nuevamente o Comunicate con Factuleon...!", "error");
               this.cargando = false;
            }); 
         },
         create_parametro: function(){
               ...
               swal("No se pude Culminar..!!", "Por Favor Intenta Nuevamente o Comunicate con Factuleon...!", "error");
            });
         },
         ...
         buscar_parametro: function(){
            ...
            this.$http.post('parametro_search', this.new_parametro).then(function(respuesta){
               ...
               this.cargando_parametros = false;
                ...
                swal("No Logre Buscar..!!", "Por Favor Intenta NUevamente o Comunicate con Factuleon...!", "error");
               this.cargando_parametros = false;
            }); 
         },
        ...
        show_cod_padres: function () {
            ...
            this.$http.get('hot_parametro_cod_padre').then(function(respuesta){
               ...
               swal("No se pudo recuperar los Código Padres", "Por Favor Intenta Nuevamente o Comunicate con Factuleon...!", "error");
               this.cargando = false;
            }); 
        },
